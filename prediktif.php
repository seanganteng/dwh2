...
/* =========================================================
   BAGIAN 3: APA YANG HARUS DILAKUKAN (REKOMENDASI RULE-BASED)
   Diturunkan otomatis dari angka di Bagian 1 & 2 — bukan AI,
   murni kondisional (if/else) berbasis ambang batas bisnis umum.
   ========================================================= */
...
// Siapkan label & data gabungan (historis + proyeksi) untuk Chart.js
...
<div class="container-fluid" style="max-width: 1320px;">
                    ...
                    <table class="table table-sm mini-table mb-0">
                        ...
                        <?php foreach ($kategoriTerlaris as $k): ?>
                            <tr>
                                ...
                                <td class="text-end">Rp <?php echo number_format((float)$k['total'], 0, ',', '.'); ?></td>
                    ...
                    <table class="table table-sm mini-table mb-0">
                        ...
                        <?php foreach ($metodePembayaran as $m): ?>
                            <tr>
                                ...
                                <td class="text-end">Rp <?php echo number_format((float)$m['total'], 0, ',', '.'); ?></td>
                            </tr>
                        <?php endforeach; ?>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <canvas id="proyeksiChart" height="90"></canvas>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <div class="fs-4 fw-bold text-primary">Rp <?php echo number_format($p['penjualan'], 0, ',', '.'); ?></div>
