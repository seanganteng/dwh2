...
$chartLabels = array_column($hasil, 'label');
$chartDwh = array_map(fn($h) => round($h['dwh_ms'], 2), $hasil);
$chartOltp = array_map(fn($h) => round($h['oltp_ms'], 2), $hasil);
?>
<!doctype html>
<html lang="id">
<head>
...
<div class="container-fluid" style="max-width: 1320px;">
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <canvas id="benchmarkChart" height="90"></canvas>
        </div>
    </div>
